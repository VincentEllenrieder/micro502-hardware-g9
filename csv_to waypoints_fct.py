...
def csv_to_waypoints(csv_file_path):
    ...
    for w in waypoints_init:
        ...
        corners.append([corner_x1, corner_y1, float(z - size / 2)])    # bottom left
        corners.append([corner_x1, corner_y1, float(z + size / 2)])    # top left
        corners.append([corner_x2, corner_y2, float(z + size / 2)])    # top right
        corners.append([corner_x2, corner_y2, float(z - size / 2)])    # bottom right
